...
const char* deepgramApiKey = "a6c02fc4b98b2f378b76cd9bcc7d59ed7889a1a4";    // ### INSERT your Deepgram credentials !
...
#define TIMEOUT_DEEPGRAM   20   // define your preferred max. waiting time [sec] for Deepgram transcription response     
...
{ 
  ...
  // ### meanwhile no longer needed as we don't use 'Deepgram_KeepAlive() any longer, but keeping as reference
